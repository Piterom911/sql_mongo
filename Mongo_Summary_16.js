...
// имя_поля: 1 - если нужно вывести
// имя_поля: 0 - если не нужно
...
db.employees.find({department: {$nin: ['IT', 'Sales', 'HR']}})
...
db.employees.find(
    {department: 'Sales', salary: {$gt: 7000}}
)
...
db.employees.find(
    {department: {$ne: 'Finance'}, salary: {$lt: 8000}}
)
