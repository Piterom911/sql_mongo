...
-- Найти максимальные зарплаты по департаментам. Вывести название департамена и максимальную зарплату.
...
-- Найти суммы зарплат в департаментах IT, Sales, Finance и Shipping
select dep.department_name, sum(emp.salary) 
from departments as dep
join employees as emp
on dep.department_id = emp.department_id
where dep.department_name = 'IT' or dep.department_name = 'Sales' or dep.department_name = 'Finance' or dep.department_name = 'Shipping'
group by dep.department_name;
