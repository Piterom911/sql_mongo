...
// -- Вывести сотрудников, которым не зарабатывают больше 3000 и job_id не 'ST_CLERK'.

// select * from employees
// where not (salary > 3000 or job_id = 'ST_CLERK');

// select * from employees
// where not (salary > 3000 and job_id = 'ST_CLERK');
